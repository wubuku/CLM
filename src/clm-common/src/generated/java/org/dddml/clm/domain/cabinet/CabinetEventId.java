...
public class CabinetEventId implements Serializable {
    ...
    public CabinetEventId()
    {
    }

    public CabinetEventId(String cabinetId, Long version)
    {
        this.cabinetId = cabinetId;
        this.version = version;
    }
    ...
    public boolean equals(Object obj)
    {
        ...
        CabinetEventId other = (CabinetEventId)obj;
        return true 
            && (cabinetId == other.cabinetId || (cabinetId != null && cabinetId.equals(other.cabinetId)))
    ...
    {
        int hash = 0;
        if (this.cabinetId != null) {
            hash += 13 * this.cabinetId.hashCode();
        }
