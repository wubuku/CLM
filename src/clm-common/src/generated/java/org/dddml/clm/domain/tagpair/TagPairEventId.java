...
import org.dddml.clm.domain.TagIdPair;
import org.dddml.clm.domain.*;

public class TagPairEventId implements Serializable {
    private TagIdPair tagPairId = new TagIdPair();
    ...
    protected String getTagPairIdA()
    {
        return getTagPairId().getA();
    }

    protected void setTagPairIdA(String tagPairIdA)
    {
        getTagPairId().setA(tagPairIdA);
    }

    protected String getTagPairIdB()
    {
        return getTagPairId().getB();
    }

    protected void setTagPairIdB(String tagPairIdB)
    {
        getTagPairId().setB(tagPairIdB);
    }

    public TagPairEventId()
    {
    }

    public TagPairEventId(TagIdPair tagPairId, Long version)
    {
        this.tagPairId = tagPairId;
        this.version = version;
    }
    ...
    public boolean equals(Object obj)
    {
        ...
        TagPairEventId other = (TagPairEventId)obj;
        return true 
            && (tagPairId == other.tagPairId || (tagPairId != null && tagPairId.equals(other.tagPairId)))
    ...
    {
        int hash = 0;
        if (this.tagPairId != null) {
            hash += 13 * this.tagPairId.hashCode();
        }
